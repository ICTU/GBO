...
![](media/image1.png){width="6.268055555555556in" height="5.254861111111111in"}
...
**ODRL (Open Digital Rights Language).** W3C-standaard voor machineleesbare beleidsrepresentatie in het grondslagenregister. Wordt al ingezet in FDS en DCAT-AP NL voor beleidsbeschrijving.
...
De onderstaande tabel geeft een beknopt overzicht van de tien GBO stelselfuncties, hun huidige invulling en de voornaamste gaps. Geel gemarkeerde items zijn nog niet beschikbaar en moeten worden gerealiseerd. De volledige uitwerking per stelselfunctie is opgenomen in de PSA.
...
+——————————————————--+——————————————————————+—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————+
| S05 — Beleidsbeheer & -distributie (PAP)             | Nog te ontwerpen ⚠️                                              | Centrale voorziening voor het beheren en distribueren van OPA/Rego-policy-bundles naar alle bronhouder-PDPs en de FSC Manager.                                                                                                                                                                                                                                                                                                                                            |
|                                                        |                                                                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|                                                        |                                                                  | De PAP is het technisch-bestuurlijke gezagspunt van het stelsel: hij bepaalt wat iedere deelnemer mag. Vereist een expliciete governance-afspraak over wie policies mag schrijven, wijzigen en goedkeuren.                                                                                                                                                                                                                                                                |
+——————————————————--+——————————————————————+—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————+
