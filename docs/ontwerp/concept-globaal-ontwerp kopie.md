...
- Europese afspraken en standaarden (EIF, eIDAS, SDG/OOTS, ETSI) en de Nederlandse invulling hiervan (NL-Wallet, centraal Nederlands OOTS toegangspunt).
...
# 3 Generieke functies en stelselfuncties - GBO
...
Deze generieke functies worden ingevuld met stelselfuncties: afspraken, standaarden en / of voorzieningen
